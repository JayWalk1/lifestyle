...
function calculateBitcoin() {
    ...
    while (dateIterator <= currentDate) {
        ...
        if (price) {
            ...
            totalBitcoin += weeklySpend / price;
        } else {
    ...
    document.getElementById('result').innerHTML = `
        ...
        If you invested it in ${bitcoinSymbol}: ${totalBitcoin.toFixed(6)} ${bitcoinSymbol} worth approximately ${currencySymbols[currency]}${totalValue.toLocaleString()}
    `;
}
