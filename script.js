const bitcoinPricesUSD = {
    ...
    '2024-01': 48570.39, '2024-02': 51823.48, '2024-03': 55245.60, '2024-04': 58427.29, '2024-05': 60581.54, '2024-06': 62534.29, '2024-07': 64580.60, '2024-08': 63050.60, '2024-09': 59000.00
};
...
function calculateBitcoin() {
   ...
   // Loop through each month from the start date to the end date
    ...
    document.getElementById('result').innerHTML = `
        ...
        If you invested it in ${bitcoinSymbol}: ${totalBitcoin.toFixed(6)} ${bitcoinSymbol} worth approximately ${currencySymbol}${totalValue.toLocaleString()}
    `;
}
